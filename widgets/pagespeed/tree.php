...
if (strlen($testPath) && strlen($div)) {
    ...
    echo "pagespeed_tree_css.setAttribute('href', '$css');\n";
    echo "var pagespeed_tree_first_script=document.getElementsByTagName('script')[0];\n";
...
jQuery("#pagespeed_tree").treeview({prerendered: true});
