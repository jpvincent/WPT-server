            ...
            <form method="post" class="cmxform" action="updateLocation.php" id="updateForm">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td><input type="checkbox" id="valid" name="valid" value="1"
                ...
                <tr>
                  ...
                  <td><input type="text" size="80" name="location" id="location"
                             value="{$location.Location}" class="required"></td>
                </tr>
                <tr>
                  <td align="right"><label for="label">Label</label></td>
                  <td><input type="text" size="80" name="label" id="label" value="{$location.Label}"
                             class="required"></td>
                </tr>
                <tr>
                  <td align="right"><label for="browser">Browser</label></td>
                  <td><input type="text" id="browser" name="browser" value="{$location.Browser}"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="text" id="queuethresholdgreenlimit" name="queuethresholdgreenlimit"
                             value="{$location.QueueThresholdGreenLimit}" style="width:70px;">
                  </td>
                </tr>
                <tr>
                  ...
                  <td><input type="text" id="queuethresholdyellowlimit" name="queuethresholdyellowlimit"
                             value="{$location.QueueThresholdYellowLimit}" style="width:70px;">
                  </td>
                </tr>
                <tr>
                  ...
                  <td><input type="text" id="queuethresholdredlimit" name="queuethresholdredlimit"
                             value="{$location.QueueThresholdRedLimit}" style="width:70px;">
                  </td>
                </tr>
                <tr>
                  <td></td>
