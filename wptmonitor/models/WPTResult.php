...
class WPTResult extends Doctrine_Record
{
  public function setTableDefinition()
  {
    ...
    // To support jobs that result in multiple pages/sequences
    $this->hasColumn( 'SequenceNumber', 'integer', 8 );
    // The script used at the time of execution
    $this->hasColumn('URLScript', 'string');
    // The corresponding "event" name from webpagetest for this entry
    $this->hasColumn('WPTEventName', 'string');
    // The corresponding "page title" from webpagetest
    $this->hasColumn('WPTPageTitle', 'string');
    $this->hasColumn('TimeToLoadTitle', 'integer', 12 );
    $this->hasColumn('TimeToLoadTitleRepeatView', 'integer', 12 );
    ...
    $this->hasColumn( 'WPTLocation', 'string', 255, array( 'type' => 'string', 'length' => 255 ) );
